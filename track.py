...
def run(
        ...
        send_signal=True, # send signal --send-signal
                            ...
                            with open(txt_path + '.txt', 'a') as f:
                                ...
                                if (bbox_w > 0):
                                   #while True:
                                      # mycmd = '40'
                                      # mycmd = mycmd + '\r'
                                      # arduino.write(mycmd.encode())
                                   direction = 0
                                   # Call a function to process the frame and calculate the steering angle
                                   steering_angle = 90
                                   # argument1 = 'steering_angle'  # Replace with the value of your variable
                                   bat_file_path = 'C:\\Users\\BITS\\Desktop\\steer.bat'
                                   subprocess.call(['cmd', '/C', bat_file_path, str(steering_angle), str(direction)])
                                   # print("1")
                                   # ser.write(b'H')
                               # elif (len(output) == 0):
                                  #  os.startfile("L.bat")
